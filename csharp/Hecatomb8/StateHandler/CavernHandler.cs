...
namespace Hecatomb8
{
    ...
    public class CavernHandler : StateHandler
    {
        ...
        public void DigCaverns(int z)
        {
            ...
            var cells = new CellularAutomaton(world.Width, world.Height);
            ...
            for (int x = 1; x < world.Width - 1; x++)
            {
                for (int y = 1; y < world.Height - 1; y++)
                {
                    ...
                    {
                        Terrains.SetWithBoundsChecked(x, y, z, Terrain.FloorTile);
            ...
            flood = (int x, int y) =>
            {
                ...
                {
                    if (!Terrains.GetWithBoundsChecked(n.X, n.Y, n.Z).Solid && !zones.ContainsKey(n))
                    {
                        flood!(n.X, n.Y);
                    }
                }
            ...
            for (int x = 1; x < world.Width - 1; x++)
            {
                for (int y = 1; y < world.Height - 1; y++)
                {
                    ...
                    if (!Terrains.GetWithBoundsChecked(x, y, z).Solid && !zones.ContainsKey(c))
                    {
                        flood(x, y);
                        zone += 1;
                    }
