  ...
  */
  ...
  new Tutorial({
    ...
    instructions: [
      "%c{white}You walk amongst the tombstones of a hillside graveyard, searching for the site upon which you will build your mighty fortress.",
      " ",
      '- Green areas with %c{#99DD77}" %c{lime}are grass.',
      " ",
      "- Dim green areas are also grass, one elevation level below you.",
      " ",
      "- Gray areas with %c{#BBBBBB}# %c{lime}are walls, but they may have walkable floors one level above you.",
      " ",
      "- Other symbols (%c{#99DD77}\u2663%c{lime}, %c{#99DD77}\u2660%c{lime}, %c{#99DD77}\u2698%c{lime}) may be trees or plants.",
      " ",
      "- Letters such as %c{#BBBBBB}s%c{lime} or %c{#BBBBBB}b%c{lime} are wild animals, mostly harmless for now.",
      " ",
      "%c{cyan}%b{DarkRed}Try walking around using the numeric keypad.  If your keyboard has no keypad, use the arrow keys.  One turn will pass for each step you take."
    ],
    listens: ["Command"],
